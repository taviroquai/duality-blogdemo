...
$server->addRoute('/^\/admin$/', '\Blog\Controller\Admin@doIndex');
$server->addRoute('/^\/admin\/edit\/([0-9]+)$/', '\Blog\Controller\Admin@doPostEdit');
$server->addRoute('/^\/admin\/save\/([0-9]+)$/', '\Blog\Controller\Admin@doPostSave');
$server->addRoute('/^\/admin\/del\/([0-9]+)$/', '\Blog\Controller\Admin@doPostDel');
$server->addRoute('/^\/admin\/comment\/edit\/([0-9]+)$/', '\Blog\Controller\Admin@doCommentEdit');
$server->addRoute('/^\/admin\/comment\/save\/([0-9]+)$/', '\Blog\Controller\Admin@doCommentSave');
$server->addRoute('/^\/admin\/comment\/del\/([0-9]+)$/', '\Blog\Controller\Admin@doCommentDel');
